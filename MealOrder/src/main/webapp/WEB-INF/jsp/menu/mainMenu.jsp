...
td.mainMenu{border: 1px solid #DDDDDD;}
...
$(function(){
	  $("td.mainMenu").mouseover(function(){
		  $(this).css("border-color","red");
	  });
});
$(function(){
	  $("td.mainMenu").mouseout(function(){		 
    ...
    <div>                                                                   
      <table border="0" cellpadding="10" cellspacing="10">
        <tr>
           <td class="mainMenu">
             <div class="box">
               <a href="/MealOrder/menu/subMenu/ccMenu">
                   <img src="/MealOrder/image/dishAttribution/cc.jpg" alt=""/><br/><br/>
               </a>
             </div>
           </td>
           <td class="mainMenu">
             <div class="box">
               <a href="/MealOrder/menu/subMenu/xcMenu">
                  <img src="/MealOrder/image/dishAttribution/xc.jpg" alt=""/><br/><br/>
               </a>
             </div>
           </td>
        </tr>       
