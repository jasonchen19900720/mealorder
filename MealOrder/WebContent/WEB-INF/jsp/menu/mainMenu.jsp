    ...
    <div>                                                                   
      <table border="0" cellpadding="10" cellspacing="10">
        <tr>
           <td class="menuClass">
             <div class="box">
               <a href="/MealOrder/order/menu/ccMenu"><img src="/MealOrder/image/cc.jpg" alt=""/><br/><br/></a>
             </div>
           </td>
           <td class="menuClass">
             <div class="box">
               <a href="/MealOrder/order/menu/xcMenu"><img src="/MealOrder/image/xc.jpg" alt=""/><br/><br/></a>
             </div>
           </td>
        </tr>       
      </table>       
