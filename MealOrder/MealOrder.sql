...
insert into `dish` (`dishName`,`imgSrc`,`attribution`,`price`) values('回锅肉','hgr.jpg','sichuanDish','30'),('清蒸鲫鱼','qzjy.jpg','sichuanDish','50'),('红烧牛肉','hsnr.jpg','sichuanDish','60'),('清炖猪蹄','qdzt.jpg','sichuanDish','60');
